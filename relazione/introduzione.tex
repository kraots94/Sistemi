...
Alcuni problemi che potrebbero emergere in un contesto distribuito, interessanti da affrontare nella costruzione del sistema, sono: la possibilità di rottura di un veicolo, il cambio destinazione di un utente, il cambiamento della topologia della città, la scelta del miglior taxi da assegnare al cliente.
...
I clienti che vogliono usufruire del servizio inviano la propria richiesta alla vettura tramite delle speciali celle riservate alla comunicazione cliente-taxi, simili a dei ripetitori. Queste strutture hanno come unico scopo quello di permettere lo scambio di messaggi tra clienti e taxi in modo bidirezionale. Questo permette di evitare la situazione in cui un cliente non possa comunicare con alcun veicolo.
