...
In questo capitolo, vengono descritti i requisiti funzionali e non, vale a dire le possibilità offerte al cliente e i requisiti di qualità del sistema.
...
Come conseguenza del CAP Theorem, e quindi dell'impossibilità di garantire consistenza, disponibilità e tolleranza alle partizioni assieme, si è valutato, per il progetto in esame, di considerare disponibilità tolleranza alle partizioni.
