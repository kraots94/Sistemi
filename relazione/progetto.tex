...
Le relazioni e le dipendenze tra di essi sono presenti alle immagini \ref{fig:schema_moduli_livello_0} e \ref{fig:schema_moduli_livello_1}.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=10cm]{schema_moduli_livello_0.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=12cm]{schema_moduli_livello_1.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=13cm]{schema_moduli_livello_2.jpg}
